...
////////////////////////////
  ...
  Template.elem_viz_controls.helpers({
...
////////////////////////////
  ...
  Template.elem_viz_controls.events({
...
// function initDateVis(){
  ...
  // elems.forEach(function(elem){
    // if (elem.metadata.tags.date != undefined && 
      // elem.metadata.tags.date[0] != undefined ){
      // var label = "ind: "+ind;
      // if (elem.metadata.tags.title != undefined){// we have a title
        // label = song.metadata.tags.artist[0] + " - " + 
        // elem.metadata.tags.title[0];
      // }  
      // var value = elem[Session.get("feature")["type"]][Session.get("feature")["name"]];
      // var date = elem.metadata.tags.date[0] + "-01-01";
